...
namespace VotacionesWebBack.Controllers
{
    ...
    public class VotantesController : ControllerBase
    {
        ...
        public VotantesController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Votante>> PostVotante(Votante votante)
        {
            ...
            return CreatedAtAction("GetVotante", new { id = votante.Cedula }, votante);
        }
        ...
        {
            return _context.Votantes.Any(e => e.Cedula == id);
        }
    }
}
